...
const PUBLIC_PATHS = [ROUTES.login, "/l/", "/r/", "/api/l/", "/apply/", "/api/apply/"];
...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon\\.ico|api|l/|r/|apply/|apple-touch-icon|icon\\.svg|icon-\\d|icons/|manifest|sw\\.js|workbox-|fonts/|images/).*)",
  ],
};
