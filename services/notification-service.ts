...
const BASE_EVENT_TO_CATEGORY = {
  ...
  va_task_assigned: "task",
  va_content_scheduled: "task",
  va_content_completed: "task",
  model_content_request_created: "model",
  ...
  va_statistics_weekly_summary: "system",
  ai_notification_digest: "system",
  ...
  shadowban_lifted_reported: "system",
  winner_video_approved: "system",
  winner_video_rejected: "system",
  winner_video_submitted: "system",
  research_assigned_to_creative: "system",
  creative_script_submitted: "system",
  creative_script_approved: "system",
  creative_script_rejected: "system",
  creative_script_resubmitted: "system",
  bunch_assigned_to_filmer: "system",
  bunch_filming_uploaded: "system",
  filming_schedule_created: "system",
  bunch_assigned_to_editor: "system",
  bunch_editing_uploaded: "system",
  bunch_icloud_organized: "system",
  recreate_video_slot_deleted: "system",
  material_until_approaching: "system",
  infloww_performance_alert: "system",
  spot_check_logged: "system",
  spot_check_status_changed: "system",
  daily_review_submitted: "system",
  daily_review_saved: "system",
...
const EVENT_TO_PREF_KEY: Partial<Record<NotificationEventType, NotificationPreferenceGateKey>> = {
  ...
  va_task_assigned: "task_alerts",
  model_content_request_created: "model_alerts",
  model_content_request_reviewed: "model_alerts",
  ...
  shadowban_lifted_reported: "marketing_alerts",
  winner_video_approved: "marketing_alerts",
  winner_video_rejected: "marketing_alerts",
  winner_video_submitted: "marketing_alerts",
  research_assigned_to_creative: "marketing_alerts",
  creative_script_submitted: "marketing_alerts",
  creative_script_approved: "marketing_alerts",
  creative_script_rejected: "marketing_alerts",
  creative_script_resubmitted: "marketing_alerts",
  bunch_assigned_to_filmer: "marketing_alerts",
  bunch_filming_uploaded: "marketing_alerts",
  bunch_assigned_to_editor: "marketing_alerts",
  bunch_editing_uploaded: "marketing_alerts",
  bunch_icloud_organized: "marketing_alerts",
  recreate_video_slot_deleted: "marketing_alerts",
  material_until_approaching: "marketing_alerts",
  infloww_performance_alert: "marketing_alerts",
  filming_schedule_created: "schedule_alerts",
  spot_check_logged: "marketing_alerts",
  spot_check_status_changed: "marketing_alerts",
  daily_review_submitted: "marketing_alerts",
  daily_review_saved: "marketing_alerts",
  ...
  va_statistics_weekly_summary: "system_alerts",
  ai_notification_digest: "system_alerts",
  password_changed: "system_alerts",
  user_created: "system_alerts",
  role_changed: "system_alerts",
  account_deleted: "system_alerts",
  account_update: "system_alerts",
...
async function getRecipientPushContext(userId: string): Promise<{
  ...
  try {
    ...
    if (!user?.role) return { role: undefined, roleDefaults: null };
    const roleDefaults = await getNotificationDefaultsForRole(user.role);
    return { role: user.role, roleDefaults };
  } catch {
