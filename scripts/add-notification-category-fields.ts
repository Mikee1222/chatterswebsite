#!/usr/bin/env npx tsx
/**
 * Idempotently add notification preference checkbox fields for reorganized categories
 * via the Airtable Meta API.
 *
 * Requires: AIRTABLE_TOKEN with schema.bases:read + schema.bases:write, AIRTABLE_BASE_ID.
 * Usage: npx tsx scripts/add-notification-category-fields.ts
 */
