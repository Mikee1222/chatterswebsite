#!/usr/bin/env npx tsx
/**
 * Idempotent seed: Marketing Executives US SOP role + 29 functions (English).
 * Greek "Marketing Executive" role is never modified.
 *
 * Usage: npx tsx scripts/seed-marketing-executives-us-sop.ts
 */
import "dotenv/config";
import { getSupabaseServiceClient } from "@/lib/supabase-server";
import { MARKETING_EXECUTIVES_US_FUNCTIONS } from "@/lib/sop-seed/marketing-executives-us-functions";

const SOP_ROLE_SLUG = "marketing-executives-us";
const SOP_ROLE_NAME = "Marketing Executives US";
const MARKETING_DEPT_ID = "1c6713c4-ffa4-468e-bc2f-bb972cd24182";
const AUTH_ROLE = "marketing-executives-us";
...
async function main(): Promise<void> {
  ...
  console.log(
    `[seed] Done — ${MARKETING_EXECUTIVES_US_FUNCTIONS.length} functions (${created} created, ${updated} updated).`
  );
}
