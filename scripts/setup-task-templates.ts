...
const DAILY_MARKETING_SEED = {
  ...
  description: "Standard daily marketing workflow: IP check, warm-up, and posting.",
  category: "marketing" as const,
  phases: [
    {
      title: "IP Rotation & Account Status Check",
      description: "",
      items: [
        { title: "Verify mobile data, Wi-Fi off", requires_screenshot: false, sort_order: 0 },
        { title: "Confirm IP changed via WhatIsMyIp.com", requires_screenshot: true, sort_order: 1 },
        { title: "Check Account Status on all handles - must be green", requires_screenshot: true, sort_order: 2 },
      ],
    },
    {
      ...
      description: "",
      items: [
        { title: "Scroll Explore/Reels 3-5 minutes", requires_screenshot: false, sort_order: 0 },
        { title: "Like 3-5 random posts outside niche", requires_screenshot: false, sort_order: 1 },
        { title: "Watch 5-10 stories", requires_screenshot: false, sort_order: 2 },
      ],
    },
    {
      title: "Posting",
      description: "",
      items: [
        { title: "Post IG Reel/feed post", requires_screenshot: true, sort_order: 0 },
        { title: "Post TikTok video", requires_screenshot: true, sort_order: 1 },
        { title: "Post evening CTA story with link sticker", requires_screenshot: true, sort_order: 2 },
      ],
    },
  ],
};
