...
import { buildApplyPageMetadata } from "@/lib/site-metadata";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // Curated English SEO — never reuse long bilingual form body or parent Greek/internal copy.
  return buildApplyPageMetadata({
    slug,
