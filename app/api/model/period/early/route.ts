...
import { getModelCycleInfoResponse, getUpcomingPeriod, markCurrentPeriodCameEarly } from "@/services/model-periods";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    await markCurrentPeriodCameEarly(ctx.linkedModelId);
