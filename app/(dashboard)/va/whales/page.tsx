...
import { VAWhalesClient } from "@/components/va-whales-client";
...
export default async function VAWhalesPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  const offset =
    (typeof params.offset === "string" ? params.offset : Array.isArray(params.offset) ? params.offset[0] : undefined) ??
    undefined;
