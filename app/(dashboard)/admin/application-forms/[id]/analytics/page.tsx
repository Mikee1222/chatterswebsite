...
import { AdminApplicationAnalyticsClient } from "@/components/admin-application-analytics-client";

type Props = { params: Promise<{ id: string }> };

export default async function AdminApplicationFormAnalyticsPage({ params }: Props) {
  ...
  return <AdminApplicationAnalyticsClient form={form} canManage={canManage} />;
}
