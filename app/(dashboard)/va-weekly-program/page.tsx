  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-white md:text-3xl">Weekly program</h1>
        ...
        {entries.length > 0 && (
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-white/45">Shifts this week</p>
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-white/45">Working days</p>
              <p className="mt-1 text-xl font-medium text-white/95">{workingDays}</p>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-white/45">Assigned models</p>
                      ...
                      >
                        ...
                        {e.notes?.trim() && (
                          <p className="text-xs text-white/50 leading-relaxed">
                            {e.notes.trim().length > 80 ? `${e.notes.trim().slice(0, 80)}…` : e.notes.trim()}
                          </p>
                        )}
                      </li>
                    ))}
      ...
      {entries.length === 0 && (
        ...
        >
          <p className="text-base font-medium text-white/70">No scheduled shifts for this week yet.</p>
          <p className="text-sm text-white/50">Your VA weekly program will appear here when assigned.</p>
        </div>
      )}
    </div>
  );
