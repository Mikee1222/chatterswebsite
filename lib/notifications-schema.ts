...
const EVENT_TYPE_TO_AIRTABLE_BASE: Record<string, NotificationEventTypeAirtable> = {
  ...
  ai_notification_digest: "system_alert",
  ...
  bunch_assigned_to_filmer: "bunch_assigned_to_filmer",
  bunch_filming_uploaded: "bunch_filming_uploaded",
  filming_schedule_created: "filming_schedule_created",
