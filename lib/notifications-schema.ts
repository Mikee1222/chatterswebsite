...
const EVENT_TYPE_TO_AIRTABLE_BASE: Record<string, NotificationEventTypeAirtable> = {
  ...
  task_completed: "task_shift_ended",
  task_overdue: "task_shift_started",
  tasks_not_started: "task_shift_started",
  va_task_reminder: "task_shift_started",
  phase_task_completed: "task_shift_ended",
  phase_completed: "task_shift_ended",
  phase_overdue: "task_shift_started",
  all_phases_completed: "task_shift_ended",
  points_awarded: "system_alert",
  level_up: "system_alert",
  spin_available: "system_alert",
  challenge_completed: "system_alert",
  spin_result: "system_alert",
  ...
  payment_rejected: "billing_due_reminder",
  ...
  chatter_mistake_reviewed: "chatter_mistake",
  fine_issued: "system_alert",
  bonus_awarded: "system_alert",
  fine_bonus_reviewed: "system_alert",
  shadowban_report: "shadowban_report",
  shadowban_submitted: "shadowban_report",
  shadowban_resolved: "shadowban_report",
  sop_quiz_passed: "system_alert",
  sop_quiz_failed: "system_alert",
