...
export const NOTIFICATION_EVENT = {
  ...
  BUNCH_ASSIGNED_TO_FILMER: "bunch_assigned_to_filmer" as const,
  BUNCH_FILMING_UPLOADED: "bunch_filming_uploaded" as const,
  FILMING_SCHEDULE_CREATED: "filming_schedule_created" as const,
  BUNCH_ASSIGNED_TO_EDITOR: "bunch_assigned_to_editor" as const,
  BUNCH_EDITING_UPLOADED: "bunch_editing_uploaded" as const,
  BUNCH_ICLOUD_ORGANIZED: "bunch_icloud_organized" as const,
  RECREATE_VIDEO_SLOT_DELETED: "recreate_video_slot_deleted" as const,
  MATERIAL_UNTIL_APPROACHING: "material_until_approaching" as const,
  INFLOWW_PERFORMANCE_ALERT: "infloww_performance_alert" as const,
  SPOT_CHECK_LOGGED: "spot_check_logged" as const,
  SPOT_CHECK_STATUS_CHANGED: "spot_check_status_changed" as const,
  DAILY_REVIEW_SUBMITTED: "daily_review_submitted" as const,
  DAILY_REVIEW_SAVED: "daily_review_saved" as const,
...
export const DEFAULT_PRIORITY_BY_EVENT: Partial<Record<NotificationEventType, NotificationPriority>> = {
  ...
  va_statistics_weekly_summary: "normal",
  ...
  bunch_assigned_to_filmer: "high",
  bunch_filming_uploaded: "high",
  filming_schedule_created: "normal",
  bunch_assigned_to_editor: "high",
  bunch_editing_uploaded: "high",
  bunch_icloud_organized: "high",
  recreate_video_slot_deleted: "high",
  material_until_approaching: "high",
  infloww_performance_alert: "high",
  spot_check_logged: "normal",
  spot_check_status_changed: "normal",
  daily_review_submitted: "normal",
  daily_review_saved: "normal",
  tip_approved: "normal",
  tip_rejected: "normal",
...
export const NOTIFICATION_ENTITY = {
  ...
  FILMING_ASSIGNMENT: "filming_assignment",
  FILMING_SCHEDULE: "filming_schedule",
  EDITING_ASSIGNMENT: "editing_assignment",
  ICLOUD_ORGANIZATION: "icloud_organization",
  INFLOWW_PERFORMANCE: "infloww_performance",
